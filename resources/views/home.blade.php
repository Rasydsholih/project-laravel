          ...
          <div class="row">
              <div class="col-lg-6 align-self-center">
                  <div class="section-heading">
                      <h2>Welcome to<br><em>Portofolio</em>.</h2>
                  </div>
                  <div class="left-content">
                      <p>PPLG, atau Pengembangan Perangkat Lunak dan Gim, adalah bidang studi yang mengajarkan 
                        pemrograman, desain perangkat lunak, dan pengembangan gim. Siswa mempelajari bahasa 
                        pemrograman, teknik pengkodean, dan prinsip desain untuk menciptakan aplikasi dan gim yang 
                        inovatif. Program ini mempersiapkan mereka untuk berkarier di industri teknologi dengan 
                        kemampuan kreatif dan efisien dalam menciptakan solusi teknologi.
                      </p>
                  </div>
              </div>
              <div class="col-lg-4">
                  <div class="right-image">
                      <div class="thumb">
                          ...
                          <img src="assets/images/codelaravel.jpeg" alt="">
                      </div>
                  </div>
              </div>
          </div>
