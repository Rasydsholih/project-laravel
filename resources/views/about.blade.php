            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="header-text">
                        ...
                        <p>My name is Rasyd Sholih Hakim, I go to Wikrama high school, I was born in Bandung on April 01, 2008.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Rasyd Sholih Hakim<br><em>Jurusan PPLG</em>.</h2>
                    </div>
                    <div class="left-image">
                        <img src="assets/images/gwkeren.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="owl-what-they-say owl-carousel">
                                <div class="item testimonial-item">
                                    ...
                                    <h4>Motivasi Hidup</h4>
                                    <span>Q.S Al Baqarah: 195</span>
                                    <ul>
                                    <p>"Jadilah baik. Sesungguhnya Allah menyukai orang-orang yang berbuat baik."</p>
                                </div>
                                ...
                                <div class="item testimonial-item">
                                    ...
                                    <h4>Motivasi coding</h4>
                                    <span>Chris Pine, Learn to Program</span>
                                    <ul>
                                    </ul>
